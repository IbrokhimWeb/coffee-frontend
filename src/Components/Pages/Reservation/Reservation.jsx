            ...
            <section className="reservation">
                <div className="reservation__content">
                    ...
                    <div className="reservation__content--forma">
                        ...
                        <input className="reservation__content--forma--item"  type="text" placeholder='Name' />
                        <input className="reservation__content--forma--item"  type="email" placeholder='Email' />
                        <input className="reservation__content--forma--item"  type="date" placeholder='Date'/>
                        <input className="reservation__content--forma--item"  type="time" placeholder='Time'/>
                        ...
                        <button className="reservation__content--forma--item reservation__content--forma-item__btn">Book Now</button>
                    </div>
                </div>
            </section>
            {/* /Reservation Section */}
