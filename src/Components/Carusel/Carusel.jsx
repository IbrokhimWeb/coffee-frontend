...
function Carusel(props) {
    ...
    // setInterval(() => setImg( !img ), 4000)

    return (
        <>
            <div className="carusel-wrapper">
                <img className="carusel__img" src={ img ? CaruselImage1:CaruselImage2 } />
                <div className="carusel__content">
                    ...
                    <GoChevronLeft  onClick={()=>setImg(!img)} className="carusel__left-icon" />
                    <GoChevronRight onClick={()=>setImg(!img)} className="carusel__right-icon" />
                </div>
            </div>
        </>
    );
